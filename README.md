...
| [benchmarks/README.md](benchmarks/README.md) | The benchmark harness landing page: the three hosting paths, how a run works, and how to reproduce results. |
...
| [self-hosted/vllm/models/](self-hosted/vllm/models/) | Per-model serving guides (HF repo, context window, TP size, tool parser, hardware fit) for every supported model. |
| [docs/gpu-selection-h200-vs-l40s.md](docs/gpu-selection-h200-vs-l40s.md) | Which GPU to serve on: H200 slice vs g6e.4xlarge (1x L40S), same model and config. |
...
| [docs/release-notes/](docs/release-notes/) | Release notes per version, newest first. |
